...
export const useWeatherStore = defineStore('main', {
  state: () => (
    {
      ...
      selectedSearchResult: {
        ...
        lat: '41.89193',
        lon: '12.51133',
      } as SelectedSearchRes,
      isSearchOpen: false as boolean,
      language: 'en' as languageType,
      hourly: {} as HourWeatherProps,
      currentWeather: {} as HourWeatherProps,
      ...
      weekDaysWeather: {} as WeatherWeeklyDayprops,
      timezone: '' as string,
  ...
  getters: {
    ...
    getWeatherCodeForHour: (state) => (hourId: number) => state.hourly.weathercode[state.selectedDayId * 24 + hourId],
  },
